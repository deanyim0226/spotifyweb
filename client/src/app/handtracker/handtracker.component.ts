  ...
  runDetection(){
    if (this.model != null){
        let predictions = this.model.detect(this.video.nativeElement).then((predictions: any) => {
            ...
            if (pointing == 1 && closedhands == 1) this.detectedGesture = "Hand Pointing & Closed Hand";

            if (pointing == 1 && openhands == 1) this.detectedGesture = "Hand Pointing & Open Hand";
